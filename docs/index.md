...
- [Capítulo 3: Conceitos Fundamentais da Segurança Cibernética e Arquitetura de Segurança](Part-I/3-0-Cap3-Literatura-Rev.md)
...
- [Capítulo 4: Fundamentos da Segurança de Aplicações](Part-I/3-2-0-AppSec-Fundamentals.md)
    ...
    - [4.2 Why Secure Code Metters: Secure Development Principles](Part-I/3-2-0-AppSec-Fundamentals.md#3-2-1-0-secure-dev-principles.md)
        - [4.2.1 Secure Code Practices](Part-I/3-2-AppSec-Fundamentals#3-2-1-1-secure-code-practices.md)
            - [4.2.1.1 Input validation]()
            - [4.2.1.2 User authentication/ authorization]()
            - [4.2.1.3 Parameterized Queries]()
            - [4.2.1.4 Error handling]()
            - [4.2.1.5 Encryption]()
            - [4.2.1.6 Code Review and Code Reuse](Part-I/3-2-AppSec-Fundamentals.md#code-review)
    - [4.3 Vulnerability Databases](Part-I/3-2-AppSec-Fundamentals.md#vulnerability-databases)
...
- [Capítulo 6: Frameworks and Methodologies to Build More-Secured Applications](Part-I/3-3-0-SSDLC-frameworks-methods.md)
    ...
    - [6.3 Outras Abordagens Complementares](Part-I/3-3-0-SSDLC-frameworks-methods.md#)
        ...
        - [6.3.2 Center for Internet SecurityCIS](Part-I/3-3-0-SSDLC-frameworks-methods.md#)
...
- [Capítulo 11: Training Paths](Part-III/8-0-Cap8-training-paths.md#)
    - [11.1 Training Roadmaps]()  
        - [11.1.1 Security Champions Training Program - SCTP]()
        - [11.1.2 Training Roadmap for Devs and AppSec Teams]()
    

- [Capítulo 12: Application Security Posture Management System (ASPMS)](Part-III/9-0-Cap9-building-ASPMS.md#)
    - [12.1 Measure to Evolve](Part-III/9-0-Cap9-building-ASPMS.md#)
    - [12.2 O que medir e como medir?](Part-III/9-0-Cap9-building-ASPMS.md#)
        - [12.2.1 MTTR](Part-III/9-0-Cap9-building-ASPMS.md#)
        - [12.2.2 Key Performance Indicators - KPIs](Part-III/9-0-Cap9-building-ASPMS.md#)
        - [12.2.3 Continuous Feedback and Adaptation](Part-III/9-0-Cap9-building-ASPMS.md#)
        - [12.2.4 Continuous Assessment: Building a Security Scorecard](Part-III/9-0-Cap9-building-ASPMS.md#9-2-4-assessment-sec-score-card.md)
        - [12.2.5 Learning from mistakes: Incident Response and Learning](Part-III/9-0-Cap9-building-ASPMS.md#)

- [Capítulo 13: Test Case](Part-III/10-0-Cap10-case-studies.md)
    - [13.1 Test Cases](Part-I/3-2-AppSec-Fundamentals.md#test-cases)
        - [13.1.1 Attack Surface Validation](Part-I/3-2-AppSec-Fundamentals.md#attack-surface-validation)
        - [13.1.2 Automation of Vulnerability Testing (SAST, DAST, IAST)](Part-I/3-2-AppSec-Fundamentals.md#automation-of-vulnerability-testing-sast-dast-iast)
        - [13.1.3 Penetration Testing](Part-I/3-2-AppSec-Fundamentals.md#penetration-testing)
        - [13.1.4 Fuzzing Testing](Part-I/3-2-AppSec-Fundamentals.md#fuzzing-testing)
        - [13.1.5 Regression Testing](Part-I/3-2-AppSec-Fundamentals.md#regression-testing)
        - [13.1.6 Integration Testing](Part-I/3-2-AppSec-Fundamentals.md#integration-testing)
        - [13.1.7 Misuse and Abuse Cases](Part-I/3-2-AppSec-Fundamentals.md#misuse-and-abuse-cases)
