...
- [Capítulo 4: Fundamentos da Segurança de Aplicações](Part-II/4-0-CAP4-AppSec-Fundamentals.md)
    ...
    - [4.2 Why Secure Code Metters: Secure Development Principles](Part-II/4-0-AppSec-Fundamentals.md#3-2-1-0-secure-dev-principles.md)
        - [4.2.1 Secure Code Practices](Part-II/4-0-AppSec-Fundamentals#4-2-1-secure-code-practices.md)
    ...
    - [4.4 Security Controls for Code and Security Integration](Part-II/3-2-AppSec-Fundamentals.md#security-controls-for-code)
    - [4.5 Development Strategy and Models](Part-II/3-2-AppSec-Fundamentals.md#development-strategy-and-plan)
        - [4.5.1 CI/CD and DevOps](Part-II/3-2-ppSec-Fundamentals.md#ci-cd)
        - [4.5.2 Build Security in DevOps Pipelines - DevSecOps](Part-II/AppSec-Fundamentals.md#devsecops)
    - [4.6 From Right to the Left: Introducing Shift-left Security](Part-II/)
        - [4.6.1 Benefits of Early Security Integration](Part-II/)
            - [4.6.1.1 Improveing Compliance: Applicaiton Security Controls Library](Part-II/)
            - [4.6.1.2 Enhanced Security and Risk Management](Part-II/)
            - [4.6.1.3 Faster Time to Market](Part-II/)
            - [4.6.1.4 Cost Efficiency](Part-II/)
    - [4.7 Secure-by-Design Principles](Part-II/)
        - [4.7.1 Least Privilege](Part-II/3-2-AppSecFundamentals.md#least-privilege)
        - [4.7.2 Segregation of Duties (SoD)](Part-II/3-2-AppSecFundamentals.md#segregation-of-duties-sod)
        - [4.7.3 Identity and Access Control Management (IAM)](Part-II/3-2-AppSecFundamentals.md#identity-and-access-control-management-iam)
        - [4.7.4 Infrastructure as Code (IaC)](Part-II/3-2-AppSecFundamentals.md#infrastructure-as-code-iac)
        - [4.7.5 Threat Modelling](Part-II/3-2-AppSecFundamentals.md#threat-modelling)
        - [4.7.6 API and Web Service Security](Part-II/3-2-AppSecFundamentals.md#api-and-web-service)
...
- [Capítulo 6: Frameworks and Methodologies to Build More-Secured Applications](Part-II/6-0-CAP6-SSDLC-frameworks-methods.md)
    ...
    - [6.2 Estruturas de Implementação]()
        ...
        - [6.2.2 NIST Secure Software Development Framework (SSDF)](Part-II/3-3-0-SSDLC-frameworks-methods.md#)
        - [6.2.3 Microsoft Secure Development Lifecycle (SDL)](Part-II/3-3-0-SSDLC-frameworks-methods.md#)
...
- [Capítulo 7: Secure Development Lifecycle Integrity and Management: How to build and release More-Secure Code?](Part-III/7-0-CAP7-SDL-bases.md)      
    - [7.1 Application Security Toolbox](Part-III/4-Cap4-SDL-bases.md#) <!-- componente teórico -->
        - [7.1.1 SAST, DAST, IAST and SCA](Part-III/)
