...
A inclusão da A09 no OWASP Top 10 ressalta a importância de uma abordagem holística para a segurança. Apenas corrigir vulnerabilidades conhecidas não é suficiente se as organizações não conseguem monitorar suas aplicações e infraestrutura para atividades suspeitas. [ref-] A segurança deve ser uma prática contínua, incluindo a coleta e análise de logs para identificar padrões de comportamento anômalos.
